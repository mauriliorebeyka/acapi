...
public class BacktrackingStringCheck<BASE, ROOT extends AbstractCheck<?, ?, BASE, ?>>
	...
	protected BacktrackingStringCheck(ROOT root, List<TestResult<BASE>> testResults,  Function<BASE, String> function, Function<BASE, Game> gameAcessor) {
	...
	protected BacktrackingStringCheck<BASE, ROOT> self(List<TestResult<BASE>> testResults) {
		return new BacktrackingStringCheck<>(root, testResults, function, gameAcessor);
	}
