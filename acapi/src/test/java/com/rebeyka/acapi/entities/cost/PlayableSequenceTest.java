...
public class PlayableSequenceTest {
	...
	public void testPaid() {
		...
		when(mockPlayable1.getAttribute("number", Types.integer()))
				.thenReturn(new Attribute<Integer>("", 7, Types.integer(), null));
		Playable mockPlayable2 = mock(Playable.class);
		when(mockPlayable2.getAttribute("number", Types.integer()))
				.thenReturn(new Attribute<Integer>("", 8, Types.integer(), null));
	...
	public void testNot() {
		Playable mockPlayable1 = mock(Playable.class);
		when(mockPlayable1.getAttribute("number", Types.integer()))
				.thenReturn(new Attribute<Integer>("", 1, Types.integer(), null));
		Playable mockPlayable2 = mock(Playable.class);
		when(mockPlayable2.getAttribute("number", Types.integer()))
				.thenReturn(new Attribute<Integer>("", 3, Types.integer(), null));
		PlayableSequenceCost cost = new PlayableSequenceCost("number");
	...
	public void testWrong() {
		...
		when(mockPlayable2right.getAttribute("number", Types.integer()))
				.thenReturn(new Attribute<Integer>("", Types.integer(), null));
		PlayableSequenceCost cost = new PlayableSequenceCost("number");
